<script>
  ...
  <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl text-center">
        <a href="#" class="flex justify-center items-center text-2xl font-semibold text-green-600 dark:text-white">
        ...
        <p class="my-6 text-gray-500 dark:text-gray-400">Created by <a class="text-green-600" href="https://twitter.com/buildWithDeclan">Declan</a></p>
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">DmailFi™</a>. All Rights Reserved.</span>
    </div>
  </footer>